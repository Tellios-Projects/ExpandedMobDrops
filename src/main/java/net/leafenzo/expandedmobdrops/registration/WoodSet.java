...
package net.leafenzo.expandedmobdrops.registration;
...
import net.leafenzo.expandedmobdrops.entity.ModBoatEntity;
import net.leafenzo.expandedmobdrops.entity.ModEntityTypes;
import net.leafenzo.expandedmobdrops.item.custom.ModBoatItem;
import net.leafenzo.expandedmobdrops.registries.ModFabricRegistries;
import net.leafenzo.expandedmobdrops.registry.tag.ModTags;
...
import static net.leafenzo.expandedmobdrops.registration.ModRegistryHelper.*;
