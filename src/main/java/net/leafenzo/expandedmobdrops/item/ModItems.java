...
public class ModItems {
     public static final HashMap<ItemConvertible, ItemConvertible> COOKED_MEAT_FROM_RAW_MEAT= new HashMap<ItemConvertible, ItemConvertible>();
     public static final ArrayList<ItemConvertible> HIDES = new ArrayList<>();
     ...
     static { COOKED_MEAT_FROM_RAW_MEAT.put(BEAR_MEAT, BEAR_STEAK); }
     ...
     public static final Item STRIDER_SKIN = registerItem("strider_skin", new Item(new FabricItemSettings()));
     public static final Item BEAR_HIDE = registerItem("bear_hide", new Item(new FabricItemSettings()));
     public static final Item SNIFFER_HIDE = registerItem("sniffer_hide", new Item(new FabricItemSettings()));
     public static final Item SCALY_HIDE = registerItem("scaly_hide", new Item(new FabricItemSettings()));
     public static final Item MOOSHROOM_HIDE = registerItem("mooshroom_hide", new Item(new FabricItemSettings()));
     public static final Item PANDA_HIDE = registerItem("panda_hide", new Item(new FabricItemSettings()));
     public static final Item POLAR_BEAR_HIDE = registerItem("polar_bear_hide", new Item(new FabricItemSettings()));
     public static final Item FOX_HIDE = registerItem("fox_hide", new Item(new FabricItemSettings()));
     static {
          HIDES.add(STRIDER_SKIN);
          HIDES.add(BEAR_HIDE);
          HIDES.add(SNIFFER_HIDE);
          HIDES.add(SCALY_HIDE);
          HIDES.add(MOOSHROOM_HIDE);
          HIDES.add(PANDA_HIDE);
          HIDES.add(POLAR_BEAR_HIDE);
          HIDES.add(FOX_HIDE);
     }
